...
| **mailman** | `apps/base/mailman/` | Upgrade auf 0.5.2 ist auf CNPG-/PVC-Restores einschließlich der PostgreSQL-Zeitspalten-Reparatur verifiziert; nach dem produktiven GitOps-Rollout Core, Web, LMTP, Zustellung und geschlossene Registrierung prüfen. |
