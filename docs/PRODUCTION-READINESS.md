...
| **mailman** | `apps/base/mailman/` | Django-Q-Stabilisierung ausrollen und OOM-/Queue-Verhalten beobachten; CSI-Restore und frisches CNPG-Backup vor dem Image-/Schema-Upgrade testen; öffentliche Registrierung muss geschlossen bleiben. |
