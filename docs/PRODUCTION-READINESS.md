...
| **nextcloud-yealink-phonebook** | `apps/base/nextcloud-yealink-phonebook/` | Liest das Nextcloud-Adressbuch alle 15 Minuten per CardDAV und stellt Yealink-XML unter einem zufälligen 256-Bit-Pfadtoken bereit. Eine IP-Allowlist ist wegen Source-NAT am Ingress-LB nicht belastbar; der Telefonbuchpfad liefert ohne Token 404 und Access-Logging ist für diesen Ingress deaktiviert, damit der Token nicht in Logs landet. Das T46S `192.168.9.150` ist als „Nextcloud Kontakte“ mit stündlichem Abruf und Anrufernamensuche konfiguriert; der erste Geräteabruf lieferte am 28.07.2026 HTTP 200 mit 17 Kontakten. Offen: Anzeige am Gerät und Namensauflösung bei einem realen Anruf prüfen. |
